...
{
    public class WebFormDependency : PortalConfigDependency
    {
        public WebFormDependency(IOrganizationService service, Utility utility, string baseServerUrl) :
        ...
        public override List<DependencyItem> ProcessDependencies(string websiteId, List<Entity> itemsList, bool searchNameOnly = true, string regex = null)
        {
            ...
            regex = REGEX_NAME_PARAM.Replace(LIQUID_CDS_TAG, "webform");
