...
namespace Futurez.XrmToolBox
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Power Apps Portal Dependencies"),
        ExportMetadata("Description", "Display dependencies for CDS items within your Power Apps Portal Configuration"),
    ...
    public class PortalDependencies : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new PortalDependenciesControl();
        }

        /// <summary>
        /// Constructor 
        /// </summary>
        public PortalDependencies()
        {
